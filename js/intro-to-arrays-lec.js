...
var favoriteFoods = ['cake', 'chocolate cake', 'all cakes'];
...
console.log(returnLastElement([2, 3, 5]));
...
pies.forEach(function(thePie){
	console.log('Here is a lovely pie: ' + thePie + '.')
});
...
instructors.forEach(function(bob){
	console.log(bob)
});
// TODO: Using a for each loop, iterate through the daysOfTheWeek array and console.log each day of the week
daysOfTheWeek.forEach(function(bob){
	console.log(bob)
});
// TODO: Using a for each loop, iterate through the favoriteFoods array and console.log each favorite food
favoriteFoods.forEach(function(bob) {
	console.log(bob)
});